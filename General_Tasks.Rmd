...
Since the values in the data are discrete, and there are not many different values in the dataset, we can set the number of bins in a way that each bin has a singular corresponding value.
...
![Decision Tree](images/decision_tree.jpg){width:80%}
...
sprintf(
  "Es wurden %s Autos in Adelshofen zugelassen, die Komponenten T16 enthalten",
  length(Unique_Autos_mit_T16)
)
